...
```{python}
loans_norownames = loans.drop(columns="rownames")
loans_norownames
```
...
demog_info.rename(columns={"emp_title": "employment_title", "emp_length": "employment_length_yrs"})
...
credit_vars.to_csv('credit_vars.csv')
...
high_income.to_csv("high_income.csv")
```
...
high_risk.to_csv("high_risk.csv")
```
